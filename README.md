...
Sample clients, schemes and baskets seed the database once. Replace sample use with your approved masters before operational use. Imports accept CSV or the first sheet of XLSX, add new unique IDs and reject an entire batch if it contains invalid or existing IDs. Required headers are available in the downloadable templates.
